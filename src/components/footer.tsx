    ...
    <footer className="bg-[#050505] border-t border-white/5 py-32 px-6 md:px-12">
      <div className="editorial-grid">
        <div className="md:col-span-5 space-y-12">
          ...
          <div className="flex gap-8 pt-4">
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-gold transition-all group">
              <Globe className="size-5 group-hover:scale-110" />
            </a>
            <a href="#" className="text-white/40 hover:text-gold transition-all group">
        ...
        <div className="md:col-span-3 space-y-8 mt-20 md:mt-0">
          ...
          <ul className="space-y-6">
            ...
            <li className="text-sm text-white font-bold tracking-widest font-sans underline underline-offset-8 decoration-gold/30 italic">327 319 2481</li>
          </ul>
        </div>
      ...
      <div className="mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[8px] uppercase tracking-[0.3em] text-gold/30 font-bold italic font-sans">
            Designed by LUX Digital Agency / Studio d'Eccellenza
          </p>
        </div>
        <div className="flex gap-10 font-sans">
          <Link href="#" className="text-[9px] uppercase tracking-[0.3em] text-white/20 hover:text-white transition-colors font-bold">Privacy Policy</Link>
          <Link href="#" className="text-[9px] uppercase tracking-[0.3em] text-white/20 hover:text-white transition-colors font-bold">Cookie Policy</Link>
        </div>
      </div>
    </footer>
  );
